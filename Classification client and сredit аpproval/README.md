...
# Оценка модели: Logistic Regression - F1 score = 0.85.

# Выводы: Логистическая регрессия демонстрирует высокие показатели по всем метрикам, особенно по Accuracy, Recall и F1-score, что делает её более сбалансированной и эффективной для этой задачи, по сравнению с моделью деревьев решений (DecisionTreeClassifier).
